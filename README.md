...
First format a USB drive as FAT32, then copy and paste the .z97 file from this repo to the drive. Do NOT rename the file and ensure the file is not zipped.
